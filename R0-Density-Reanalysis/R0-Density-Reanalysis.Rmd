---
title: "The importance of reproducibility in geographical research: the case of population density and the spread of COVID-19"
author:
  - name: Author
...
In the following sections, the analysis of RWN is reproduced, some relevant questions from the perspective of an independent researcher are asked, and the data are reanalyzed. 
...
selection3_me  %>%
  ...
  kable("latex",
        ...
        col.names = c("Variable",
                      ...
                      "95\\% CI"),
        align = c("lcccc"),
        caption = "\\label{tab:selection-results}Estimation results of sample selection model with spatial filter") %>%
  kable_styling(latex_options = c("scale_down")) %>% 
