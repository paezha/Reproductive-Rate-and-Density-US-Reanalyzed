...
\hypersetup{breaklinks=true,
            bookmarks=true,
            pdfauthor={},
            pdftitle={The importance of reproducibility in geographical research: the case of population density and the spread of COVID-19},
            colorlinks=false,
            urlcolor=blue,
            linkcolor=magenta,
            pdfborder={0 0 0}}
...
\caption{\label{tab:tabulate-sample-selection3-results}\label{tab:selection-results}Estimation results of sample selection model with spatial filter}
\centering
\resizebox{\linewidth}{!}{
\begin{tabular}[t]{lcc}
\toprule
