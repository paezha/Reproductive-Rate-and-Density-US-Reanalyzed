...
\begin{flushleft}
{\Large
\textbf\newline{Population density and basic reproductive number of
COVID-19 across United States counties
revisited} % Please use "sentence case" for title and headings (capitalize only the first word in a title (or heading), the first word in a subtitle (or subheading), and any proper nouns).
}
\newline
