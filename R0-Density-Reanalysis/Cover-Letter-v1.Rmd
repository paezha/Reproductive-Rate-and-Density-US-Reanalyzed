...
4. Finally, the paper provides an example of a reproducible research project, with extensively documented workflows, from raw data processing, to modelling, and post-modelling outputs. The source document is an R Markdown file, a self-contained document with the text and _all_ the analysis. These materials will be publicly available in a repository. For review purposes, they are currently in an anonymous Drive folder, and also supplied as supplementary files for review purposes.

I trust that you will find that the paper is technically correct, and suitable for review.
