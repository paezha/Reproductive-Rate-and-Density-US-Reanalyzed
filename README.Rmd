...
Paez, A (2022) Reproducibility of Research During COVID-19: Examining the Case of Population Density and the Basic Reproductive Rate from the Perspective of Spatial Analysis. Geographical Analysis. 54(4) 860-880 (https://doi.org/10.1111/gean.12307)
...
if(!require(r0density)){
    install.packages(paste0(here(), "/r0density_0.1.0.tar.gz"), repos = NULL, type="source")
    library(r0density) # not installed on this machine
}
```

```{r load-data-package, include=FALSE, cache=FALSE}
